...
object errors {
  ...
  // https://stackoverflow.com/questions/14929422/should-implicit-classes-always-extend-anyval
  // http://www.michaelpollmeier.com/2020/01/14/scala-valueclass-allocations
  object syntax {
    import either._
     ...
     */
    implicit final class FaultOrLinearSyntax[FAULT <: Throwable, E <: SingleDomainError](val faultOr : FaultOr[FAULT, _ >: E]) extends AnyVal {
     ...
     */
    implicit final class FaultOrEither2Syntax[FAULT <: Throwable, E1 <: SingleDomainError, E2 <: SingleDomainError](val faultOr : FaultOr[FAULT, Either2Error[E1, E2]]) extends AnyVal {
     ...
     */
    implicit final class FaultOrEither3Syntax[FAULT <: Throwable, E1 <: SingleDomainError, E2 <: SingleDomainError, E3 <: SingleDomainError](val faultOr : FaultOr[FAULT, Either3Error[E1, E2, E3]]) extends AnyVal {
     ...
     */
    implicit final class FaultOrEither4Syntax[FAULT <: Throwable, E1 <: SingleDomainError, E2 <: SingleDomainError, E3 <: SingleDomainError, E4 <: SingleDomainError](val faultOr : FaultOr[FAULT, Either4Error[E1, E2, E3, E4]]) extends AnyVal {
     ...
     */
    implicit final class FaultOrEither5Syntax[FAULT <: Throwable, E1 <: SingleDomainError, E2 <: SingleDomainError, E3 <: SingleDomainError, E4 <: SingleDomainError, E5 <: SingleDomainError](val faultOr : FaultOr[FAULT, Either5Error[E1, E2, E3, E4, E5]]) extends AnyVal {
     ...
     */
    implicit final class ZioThrowableSyntax[R, FAULT <: Throwable, A](val effect: zio.ZIO[R, FAULT, A]) extends AnyVal {
     ...
     * @tparam A effect result type
     */
    implicit final class ZioFromOptionSyntax[R, E <: SingleDomainError, A](val effect: zio.ZIO[R, Option[Nothing], A]) extends AnyVal {
     ...
     */
    implicit final class ZioOutcomeSyntaxWithFault[R, FAULT <: Throwable, E <: SingleDomainError, A](val effect: zio.ZIO[R, FAULT, Outcome[E, A]]) extends AnyVal {
     ...
     * @tparam A effect result type
     */
    implicit final class ZioOutcomeSyntaxWithoutFault[R, E <: SingleDomainError, A](val effect: zio.ZIO[R, Nothing, Outcome[E, A]]) extends AnyVal {
     ...
     * @tparam R effect environmental type
     * @tparam A effect result type
     * @tparam FAULT system fault type
     * @tparam E1 the Either2Error first domain error type
     * @tparam E2 the Either2Error second domain error type
     */
    implicit final class ZioOutcomeEither2Syntax[R, FAULT <: Throwable, E1 <: SingleDomainError, E2 <: SingleDomainError, A](val effect: zio.ZIO[R, FAULT, Outcome[Either2Error[E1, E2],A]]) extends AnyVal {
     ...
     * @tparam E3 the Either3Error third domain error type
     */
    implicit final class ZioOutcomeEither3Syntax[R, FAULT <: Throwable, E1 <: SingleDomainError, E2 <: SingleDomainError, E3 <: SingleDomainError, A](val effect: zio.ZIO[R, FAULT, Outcome[Either3Error[E1, E2, E3], A]]) extends AnyVal {
     ...
     * @tparam E4 the Either4Error fourth domain error type
     */
    implicit final class ZioOutcomeEither4Syntax[R, FAULT <: Throwable, E1 <: SingleDomainError, E2 <: SingleDomainError, E3 <: SingleDomainError, E4 <: SingleDomainError, A](val effect: zio.ZIO[R, FAULT, Outcome[Either4Error[E1, E2, E3, E4], A]]) extends AnyVal {
     ...
     * @tparam R effect environmental type
     * @tparam A effect result type
     * @tparam FAULT esystem fault type
     ...
     */
    implicit final class ZioOutcomeEither5Syntax[R, FAULT <: Throwable, E1 <: SingleDomainError, E2 <: SingleDomainError, E3 <: SingleDomainError, E4 <: SingleDomainError, E5 <: SingleDomainError, A](val effect: zio.ZIO[R, FAULT, Outcome[Either5Error[E1, E2, E3, E4, E5], A]]) extends AnyVal {
     ...
     * @tparam A effect result type
     */
    implicit final class ZioFaultOrThrowableSyntax[R, E <: SingleDomainError, A](val effect : ZIO[R, FaultOr[Throwable, _ >: E], A]) extends AnyVal {
      /**
     ...
     */
    implicit final class ZioFaultOrTypeBoundSyntax[R, FAULT <: Throwable, E <: SingleDomainError, A](val effect: ZIO[R, FaultOr[FAULT, _ >: E], A]) extends AnyVal {
     ...
     * @tparam A effect result type
     */
    implicit final class ZioFaultOrEmptyResult[R, E <: SingleDomainError, A](val effect: zio.ZIO[R, FaultOr[Nothing, E], A]) extends AnyVal {
     ...
     */
    implicit final class ZioFaultOrSingleErrorSyntax[R, FAULT <: Throwable, E1 <: SingleDomainError, A](val effect: zio.ZIO[R, FaultOr[FAULT, E1], A]) extends AnyVal {
      /**
     ...
     * onDomainErrorsMakeN (2..5) will trigger another ZIO effect which will produce an EitherNError domain error on any existing domain errors
     */
    implicit final class ZioFaultOrEither2Syntax[R, FAULT <: Throwable, E1 <: SingleDomainError, E2 <: SingleDomainError, A](val effect: zio.ZIO[R, FaultOr[FAULT, Either2Error[E1, E2]], A]) extends AnyVal {
     ...
     * onDomainErrorsMakeN (2..5) will trigger another ZIO effect which will produce an EitherNError domain error on any existing domain errors
     */
    implicit final class ZioFaultOrEither3Syntax[R, FAULT <: Throwable, E1 <: SingleDomainError, E2 <: SingleDomainError, E3 <: SingleDomainError, A](val effect: zio.ZIO[R, FaultOr[FAULT, Either3Error[E1, E2, E3]], A]) extends AnyVal {
     ...
     * onDomainErrorsMakeN (2..5) will trigger another ZIO effect which will produce an EitherNError domain error on any existing domain errors
     */
    implicit final class ZioFaultOrEither4Syntax[R, FAULT <: Throwable, E1 <: SingleDomainError, E2 <: SingleDomainError, E3 <: SingleDomainError, E4 <: SingleDomainError, A](val effect: zio.ZIO[R, FaultOr[FAULT, Either4Error[E1, E2, E3, E4]], A]) extends AnyVal {
     ...
     * onDomainErrorsMakeN (2..5) will trigger another ZIO effect which will produce an EitherNError domain error on any existing domain errors
     */
    implicit final class ZioFaultOrEither5Syntax[R, FAULT <: Throwable, E1 <: SingleDomainError, E2 <: SingleDomainError, E3 <: SingleDomainError, E4 <: SingleDomainError, E5 <: SingleDomainError, A](val effect: zio.ZIO[R, FaultOr[FAULT, Either5Error[E1, E2, E3, E4, E5]], A]) extends AnyVal {
